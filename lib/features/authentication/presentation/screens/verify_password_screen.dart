...
import 'package:mzady/features/authentication/presentation/widgets/listener/verify_password_listener.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              AppSize.s60.verticalSpace,
              const VerifyPasswordListener(),
              AppSize.s40.verticalSpace,
              ResendCodeSection(cubit: context.read<ForgotPasswordCubit>()),
              AppSize.s40.verticalSpace,
            ],
          ),
        ),
