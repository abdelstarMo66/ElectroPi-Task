...
class _ProfileApi implements ProfileApi {
  ...
  @override
  Future<BaseResponse<ProfileData>> getProfile({required String token}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<ProfileData>>(
    ...
    late BaseResponse<ProfileData> _value;
    try {
      _value = BaseResponse<ProfileData>.fromJson(
        _result.data!,
  ...
  Future<BaseResponse<ProfileData>> addAddress({
    required AddAddressRequestBody body,
    required String token,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
